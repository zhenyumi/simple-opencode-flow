...
6. **Tests and evidence**: determine whether tests prove the intended behavior and whether claimed verification is fresh and relevant.
...
Use `evidence.md` as the first repository-evidence context. Prefer targeted validation of cited Evidence IDs. Re-explore broadly only when evidence is missing, malformed, stale, contradicted, or materially incomplete.
